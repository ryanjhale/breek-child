...
function cfm_get_lesson(){
    ...
    if($lesson_type == 'question') {
	    ...
	    if(isset($email) && isset($name)) {
		    ...
		    $change_name_span = '<span id="change-name" style="font-size:12px;">' . $change_name . '</span>';
		    $change_email_span = '<span id="change-email" style="font-size:12px;">' . $change_email . '</span>';
			...
			if(!empty($comments[0])) {
			    ...
			    $change_response_span = '<span id="change-response" style="font-size:12px;">' . $change_response . '</span>';
